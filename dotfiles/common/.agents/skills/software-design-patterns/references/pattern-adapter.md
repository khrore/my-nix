...
- Internal policy should depend on a stable capability while edge code translates external shapes and failures.
...
- An internal contract plus an adapter that maps external input, output, and errors.
