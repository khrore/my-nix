...
- Separate the stable abstraction from implementation details so each side can evolve without subclass explosion.
...
- A front abstraction delegates implementation work to an implementation interface.
