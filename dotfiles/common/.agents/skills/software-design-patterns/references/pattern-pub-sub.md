...
- Topics decouple producers and consumers more strongly than in-object observer lists.
...
- A broker, event bus, or topic dispatcher with explicit payload contracts.
