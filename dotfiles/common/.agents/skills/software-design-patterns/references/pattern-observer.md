...
- Subject should not know every dependent behavior, but notification order and errors must be clear.
...
- Subject maintains observers and notifies them with an explicit event payload.
