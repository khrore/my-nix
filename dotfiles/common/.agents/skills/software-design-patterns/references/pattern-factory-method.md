...
- Creation varies by subclass, module, or local extension point without exposing concrete constructors to callers.
...
- A creation method returning a product interface, often overridden or supplied by a variant.
...
- Inheritance exists only for creation reuse.
