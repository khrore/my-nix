...
- Cloning should preserve intended defaults without sharing mutable state accidentally.
...
- A clone/copy operation that creates an independent object from a prototype.
