...
- Cross-cutting concerns should compose without changing the wrapped implementation.
...
- A wrapper that implements the same narrow contract and delegates to the wrapped object.
