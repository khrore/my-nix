...
- Policy should receive collaborators so tests and assembly can swap implementations explicitly.
...
- Constructor, function, or module parameters; use containers only when manual assembly is clearly worse.
