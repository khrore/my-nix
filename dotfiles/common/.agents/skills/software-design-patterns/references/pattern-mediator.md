...
- Coordination rules should live in one place when peer-to-peer knowledge becomes unstable.
...
- A mediator receives events or commands from peers and coordinates collaborators.
