...
- UI theme widgets, protocol clients and serializers, or provider-specific service bundles must stay compatible.
...
- A family factory interface that creates related products from one selected variant.
