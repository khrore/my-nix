...
- The caller can use the same narrow contract while access behavior is localized and visible at construction.
...
- A wrapper implementing the same contract and delegating to the real subject.
